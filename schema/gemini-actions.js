...
export const GEMINI_ACTIONS = {
  ...
  gemini_generate_text: {
    ...
    parameters: {
      ...
      properties: {
        ...
        temperature: {
          type: "number",
          description: "Controls randomness: lowering results in less random completions (0-1)",
          default: 0.7
        },
        maxTokens: {
          type: "integer",
  ...
  gemini_generate_with_tools: {
    ...
    description: "Generate text using Gemini with the ability to call other tools",
    parameters: {
      type: "object",
      required: ["prompt"],
      properties: {
