...
const complianceDocPath = path.resolve(process.cwd(), 'docs/compliance/stripe_services_and_policies.md');
...
export async function readComplianceDocumentation() {
  try {
    ...
    console.error("Error reading compliance documentation:", error);
